# Identidade Visual & Branding — NΞØ SMART FACTORY
...
O ecossistema é unificado por uma rede de domínios ENS que interconectam a fábrica com os tokens:

1.  **nsfactory.eth**: O Hub oficial da Fábrica (NΞØ SMART FACTORY).
2.  **neoflw.eth**: Identidade do protocolo meta (Linked to Tokenizator logic).
3.  **neoflowoff.eth**: Ponto de origem cultural e governança.
